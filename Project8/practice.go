...
//Tasks to be accomplished are mentioned after the main function
...
// // Commenting the below main func code as i have another main fucn in the same module in lists.go. Uncomment whenever you want to execute
// func main() {
